...
| source.opcua_node_id | String | OPC UA NodeId | N/A | N | OPC UA node identifier when source_type=OPCUA. |
| source.opcua_browse_name | String | UTF-8 | N/A | N | OPC UA BrowseName when source_type=OPCUA. |
| source.opcua_namespace | Integer | count | N/A | N | OPC UA namespace index when source_type=OPCUA. |
